...
namespace KeyViewer
{
    ...
    {
        public static void Generate(string DBName, string ExcelFilePath)
        {
            GenerateDatabase(DBName, ExcelFilePath);
            GenerateKeyClass(DBName);
        }
        private static void GenerateDatabase(string DBName, string ExcelPath)
        {
        ...
        private static void GenerateKeyClass(string Name)
        {
