...
namespace KeyViewer
{
    ...
    public class KeyViewerSettings : UnityModManager.ModSettings
    {
        ...
        public bool _DisplayKPS = true;
        public bool _DisplayTotal = true;
        [XmlIgnore]
        public bool DisplayKPS
        {
            get
            {
                return _DisplayKPS;
        ...
        public bool DisplayTotal
        {
            get
            {
                return _DisplayTotal;
            }
            set
            {
                IsAloneTotal = !DisplayKPS;
                _DisplayTotal = value;
            }
        }
        public bool IsAloneKPS = false;
        public bool IsAloneTotal = false;
