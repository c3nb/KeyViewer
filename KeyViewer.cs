    ...
    public class KeyViewer : MonoBehaviour
    {
        ...
        public static void UpdateKeys() {
            ...
            if (Main.Settings.DisplayTotal)
            {
                ...
                countText.color = Profile.ReleasedTextColor;
                countText.alignment = TextAnchor.LowerCenter;
                countText.text = Calculate.count + "";
        ...
        public static void UpdateKPSTotal()
        {
            ...
            keyCountTexts[KeyCode.Joystick1Button0].text = Calculate.count + "";
        }
        ...
        public static void UpdateLayout() {
            ...
            if (Main.Settings.DisplayKPS)
            {
                ...
                bgImage.rectTransform.anchorMax = Vector2.zero;
                bgImage.rectTransform.pivot = new Vector2(0.5f, 0.5f);
                bgImage.rectTransform.sizeDelta = new Vector2(KkeyWidth, KkeyHeight);
                bgImage.rectTransform.anchoredPosition =
                    new Vector2(KkeyWidth / 2, KkeyHeight / 2 - KkeyHeight);

                Image outlineImage = keyOutlineImages[KeyCode.None];
                outlineImage.rectTransform.anchorMin = Vector2.zero;
                outlineImage.rectTransform.anchorMax = Vector2.zero;
                outlineImage.rectTransform.pivot = new Vector2(0.5f, 0.5f);
                outlineImage.rectTransform.sizeDelta = new Vector2(KkeyWidth, KkeyHeight);
                outlineImage.rectTransform.anchoredPosition =
                    new Vector2(KkeyWidth / 2, KkeyHeight / 2 - KkeyHeight);

                float heightOffset = Profile.ShowKeyPressTotal ? 0 : KkeyHeight / 20f;
                Text text = keyTexts[KeyCode.None];
                text.rectTransform.anchorMin = Vector2.zero;
                text.rectTransform.anchorMax = Vector2.zero;
                text.rectTransform.pivot = new Vector2(0.5f, 0.5f);
                text.rectTransform.sizeDelta = new Vector2(KkeyWidth, KkeyHeight * 1.03f);
                text.rectTransform.anchoredPosition = 
                    new Vector2(
                        KkeyWidth / 2,
                        KkeyHeight / 2 + heightOffset - KkeyHeight + 12);
                ...
                countText.rectTransform.anchorMax = Vector2.zero;
                countText.rectTransform.pivot = new Vector2(0.5f, 0.5f);
                countText.rectTransform.sizeDelta = new Vector2(KkeyWidth, KkeyHeight * 0.8f);
                countText.rectTransform.anchoredPosition = 
                    new Vector2(
                        KkeyWidth / 2,
                        KkeyHeight / 2 - KkeyHeight - 2);
            ...
            if (Main.Settings.DisplayTotal)
            {
                ...
                bgImage.rectTransform.anchorMax = Vector2.zero;
                bgImage.rectTransform.pivot = new Vector2(0.5f, 0.5f);
                bgImage.rectTransform.sizeDelta = new Vector2(TkeyWidth, KkeyHeight);
                bgImage.rectTransform.anchoredPosition =
                    new Vector2(TkeyWidth * 1.5f, KkeyHeight / 2 - KkeyHeight);

                Image outlineImage = keyOutlineImages[KeyCode.Joystick1Button0];
                outlineImage.rectTransform.anchorMin = Vector2.zero;
                outlineImage.rectTransform.anchorMax = Vector2.zero;
                outlineImage.rectTransform.pivot = new Vector2(0.5f, 0.5f);
                outlineImage.rectTransform.sizeDelta = new Vector2(TkeyWidth, KkeyHeight);
                outlineImage.rectTransform.anchoredPosition =
                    new Vector2(TkeyWidth * 1.5f, KkeyHeight / 2 - KkeyHeight);
                ...
                text.rectTransform.anchorMax = Vector2.zero;
                text.rectTransform.pivot = new Vector2(0.5f, 0.5f);
                text.rectTransform.sizeDelta = new Vector2(TkeyWidth, KkeyHeight * 1.03f);
                text.rectTransform.anchoredPosition =
                    new Vector2(
                        TkeyWidth * 1.5f,
                        KkeyHeight / 2 + heightOffset - KkeyHeight + 12);
                ...
                countText.rectTransform.anchorMax = Vector2.zero;
                countText.rectTransform.pivot = new Vector2(0.5f, 0.5f);
                countText.rectTransform.sizeDelta = new Vector2(TkeyWidth, KkeyHeight * 0.8f);
                countText.rectTransform.anchoredPosition =
                    new Vector2(
                        TkeyWidth * 1.5f,
                        KkeyHeight / 2 - KkeyHeight - 2);
